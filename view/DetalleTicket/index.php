...
<?php require_once("../MainHead/head.php");?>
	...
	<title>jsoncode</>::Detalle Ticket</title>
</head>
...
<?php require_once("../MainNav/MainNav.php");?>
  ...
  <div class="page-content">
          ...
          <div class="tbl">
            <div class="tbl-row">
              <div class="tbl-cell">
                ...
                <span class="label label-pill label-primary" id="lblnombreusuario"></span>
		...
		<div class="box-typical box-typical-padding" id="pnldetalle">
			<p>
              ...
              <div class="row">
				  <div class="col-lg-12">
					  <fieldset class="form-group">
				            <label class="form-label semibold" for="ticketd_descrip">Descripción</label>
				            <div class="summernote-theme-1">
					          <textarea id="ticketd_descrip" name="ticketd_descrip" class="summernote" name="name"></textarea>
                            </div>
						</fieldset>
                    </div>
     ...
     <!-- Contenido -->
     <?php require_once("../Home/Mainjs/js.php");?>
